...
class StringValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            $this->message = Yii::t('yii', '{attribute} deve ser um string.');
        }
        if ($this->min !== null && $this->tooShort === null) {
            $this->tooShort = Yii::t('yii', '{attribute} deve conter pelo menos {min, number} {min, plural, one{caractere} other{caracteres}}.');
        }
        if ($this->max !== null && $this->tooLong === null) {
            $this->tooLong = Yii::t('yii', '{attribute} deve conter, no máximo {max, number} {max, plural, one{caractere} other{caracteres}}.');
        }
        if ($this->length !== null && $this->notEqual === null) {
            $this->notEqual = Yii::t('yii', '{attribute} deve conter {length, number} {length, plural, one{caractere} other{caracteres}}.');
        }
    }
