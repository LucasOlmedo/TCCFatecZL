    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            switch ($this->operator) {
                case '==':
                    $this->message = Yii::t('yii', '{attribute} deve ser igual a "{compareValueOrAttribute}".');
                    break;
                case '===':
                    $this->message = Yii::t('yii', '{attribute} deve ser igual a "{compareValueOrAttribute}".');
                    break;
                case '!=':
                    ...
                    break;
                case '!==':
                    $this->message = Yii::t('yii', '{attribute} não deve ser igual a"{compareValueOrAttribute}".');
                    break;
                case '>':
                    $this->message = Yii::t('yii', '{attribute} deve ser maior que "{compareValueOrAttribute}".');
                    break;
                case '>=':
                    $this->message = Yii::t('yii', '{attribute} deve ser maior ou igual a "{compareValueOrAttribute}".');
                    break;
                case '<':
                    $this->message = Yii::t('yii', '{attribute} deve ser menor que "{compareValueOrAttribute}".');
                    break;
                case '<=':
                    $this->message = Yii::t('yii', '{attribute} deve ser menor ou igual a "{compareValueOrAttribute}".');
                    break;
                default:
                    throw new InvalidConfigException("Operadores desconhecidos: {$this->operator}");
            }
        }
    }
